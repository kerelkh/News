                ...
                <div class="card grow p-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div x-data="usePopper({
                                ...
                                <div x-ref="popperRef" class="avatar h-10 w-10">
                                    <img class="mask is-squircle " src="{{ asset('images/avatar/male-avatar.svg') }}"
                                        alt="avatar" />
                                </div>
                                <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                    ...
                    <div class="mt-5">
                        <img class="h-48 w-full rounded-lg object-cover object-center "
                            src="{{ asset('images/background/bg.webp') }}" alt="image" />
                    </div>
                    <div class="mt-4 grow">
                        <a href="#"
                            class="text-base font-medium text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">{{ $article->title }}</a>
                        ...
                        <div class="mt-2">
                            ...
                            <a href="#"
                                class="text-xs+ text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">#{{ $tag }}
                            </a>
                        @endforeach
                        </div>
                    </div>
                    <div class="mt-3">
                        <div class="flex items-center justify-between">
                            <div class="-ml-1.5 flex">
                                <button x-tooltip.secondary="'{{ $article->like }} Like'"
